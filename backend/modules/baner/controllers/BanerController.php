<?php
    ...
    namespace backend\modules\baner\controllers;

    use yii;
    use backend\modules\baner\models\Baner;
    use backend\modules\baner\models\SearchBaner;
...
class BanerController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->saveBaner()) {
