...
namespace frontend\modules\core\widgets\SidebarLastNewsWidget;
...
class SidebarLastNewsWidget extends Widget
{
    private $news_array;
    ...
    public function run(){
        ...
        return $this->render('sidebar_news', ['news' => $this->news_array] );
    }
